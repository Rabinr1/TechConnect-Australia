(function () {
    ...
    function initContactForm() {
        ...
        contactForm.addEventListener('submit', function (e) {
            ...
            var existingFeedback = form.parentElement ? form.parentElement.querySelector('.form-feedback') : null;
            ...
            fetch(form.action, {
                ...
                feedback.innerHTML = '<i class="fas fa-check-circle" aria-hidden="true"></i><div><strong>Message sent.</strong> We will get back to you soon.</div>';
                ...
                var feedback = document.createElement('div');
                feedback.className = 'form-feedback error-banner';
                feedback.setAttribute('role', 'alert');
                feedback.innerHTML = '<i class="fas fa-exclamation-circle" aria-hidden="true"></i><div><strong>Message not sent.</strong> Please try again or contact us by phone.</div>';
